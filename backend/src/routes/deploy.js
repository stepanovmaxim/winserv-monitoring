...
function generateDeployerScript(serverUrl, regKey) {
  ...
  return [
    ...
    '      "@echo off`r`nC:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe -ExecutionPolicy Bypass -NoProfile -WindowStyle Hidden -File `"C:\\winserv-agent\\agent.ps1`"" | Set-Content -Path "$dir\\run.cmd" -Encoding ASCII -Force',
    '      schtasks /delete /tn "WinServAgent" /f 2>$null',
    '      schtasks /create /tn "WinServAgent" /ru SYSTEM /rl HIGHEST /sc minute /mo 1 /tr "C:\\winserv-agent\\run.cmd" /f',
    '    }',
