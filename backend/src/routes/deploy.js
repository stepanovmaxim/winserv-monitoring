...
function generateDeployerScript(serverUrl, regKey) {
  ...
  return [
    ...
    '    $taskSb = {',
    '      Unregister-ScheduledTask -TaskName "WinServAgent" -Confirm:$false -ErrorAction SilentlyContinue',
    '      $action = New-ScheduledTaskAction -Execute "C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\powershell.exe" -Argument "-ExecutionPolicy Bypass -NoProfile -NonInteractive -WindowStyle Hidden -File \`"C:\\winserv-agent\\agent.ps1\`""',
    '      $trigger = New-ScheduledTaskTrigger -Once -At (Get-Date).AddMinutes(-1) -RepetitionInterval (New-TimeSpan -Minutes 1)',
    '      $principal = New-ScheduledTaskPrincipal -UserId "SYSTEM" -LogonType ServiceAccount -RunLevel Highest',
    '      $settings = New-ScheduledTaskSettingsSet -AllowStartIfOnBatteries -DontStopIfGoingOnBatteries -StartWhenAvailable -MultipleInstances IgnoreNew',
    '      Register-ScheduledTask -TaskName "WinServAgent" -Action $action -Trigger $trigger -Principal $principal -Settings $settings -Force | Out-Null',
    '    }',
