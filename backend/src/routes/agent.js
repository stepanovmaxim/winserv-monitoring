...
function generateUniversalScript(serverUrl, regKey) {
  return [
    ...
    '      $hBody = @{token=$Token;hostname=$FullHostname;pending_reboot=$health.pending_reboot;services=$health.services;certs=$health.certs;tasks=$health.tasks;defender=$defender} | ConvertTo-Json -Depth 6',
