...
function generateUniversalScript(serverUrl, regKey) {
  return [
    ...
    '  $events = $null',
    '  try {',
    '    $events = Invoke-Bounded { Get-WinEvent -FilterHashtable @{LogName="System";Level=1,2,3;StartTime=$using_since} -MaxEvents 200 -ErrorAction Stop } 25',
    ...
    '  $since = (Get-Date).AddMinutes(-30)',
    '  try {',
    '    $events = Invoke-Bounded { Get-WinEvent -FilterHashtable @{LogName="Security";Id=4624,4625;StartTime=$using_since} -MaxEvents 150 -ErrorAction Stop } 25',
